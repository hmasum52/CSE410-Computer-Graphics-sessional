...
int main(int argc, char* argv[]){
    ...
    string filename = "../test-cases-part2/2/scene.txt";
    ...
    /*
    init traingle with 3 vertices
    0.50 0.00 0.50
    -0.50 0.00 0.50
    0.00 0.50 0.50
    */
    // triangles[0].vertex[0] = Vector3D(0.50, 0.00, 0.50);
    // triangles[0].vertex[1] = Vector3D(-0.50, 0.00, 0.50);
    // triangles[0].vertex[2] = Vector3D(0.00, 0.50, 0.50);
    ...
    // open config file
    string config_filename = argc > 2 ? argv[2] : "../test-cases-part2/2/config.txt";
